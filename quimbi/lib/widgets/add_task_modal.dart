...
class _AddTaskModalState extends State<AddTaskModal> {
        ...
        AnimatedOpacity(
          ...
          child: IgnorePointer(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('suggest a time', style: TextStyle(fontFamily: 'Anonymous Pro', fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF333333))),
              Text('(max 3 notifications)', style: TextStyle(fontFamily: 'Anonymous Pro', fontSize: 12, color: Colors.grey.shade400)),
              const SizedBox(height: 8),
  ...
  Future<void> _pickTime({required TimeOfDay initial, required ValueChanged<TimeOfDay> onPicked}) async {
    final picked = await showDialog<TimeOfDay>(
      context: context,
      barrierColor: Colors.black38,
      builder: (_) => Align(
        alignment: const Alignment(0, 0.5),
        child: _TimeRollerSheet(initial: initial, accent: _accent),
      ),
    );
...
class _TimeRollerSheet extends StatefulWidget {
  final TimeOfDay initial;
  final Color accent;
  const _TimeRollerSheet({required this.initial, required this.accent});

  @override
  State<_TimeRollerSheet> createState() => _TimeRollerSheetState();
}

class _TimeRollerSheetState extends State<_TimeRollerSheet> {
          ...
          Padding(
            ...
            child: Row(children: [
              Text(
                ...
                style: TextStyle(fontFamily: 'Anonymous Pro', fontSize: 15, fontWeight: FontWeight.bold, color: widget.accent),
              ),
              const Spacer(),
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Text('set', style: TextStyle(fontFamily: 'Anonymous Pro', fontSize: 12, fontWeight: FontWeight.bold, color: Colors.white)),
                ),
              ),
            ]),
          ),
...
class _DayOfMonthDialogState extends State<_DayOfMonthDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: const Text('repeat on day', style: TextStyle(fontFamily: 'Anonymous Pro', fontSize: 16, fontWeight: FontWeight.bold)),
      content: SizedBox(
        width: 280,
          ...
          itemBuilder: (_, i) {
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                duration: const Duration(milliseconds: 150),
                decoration: BoxDecoration(
                  color: sel ? widget.accent : const Color(0xFFF0F0F0),
                  shape: BoxShape.circle,
                ),
                child: Center(child: Text('$day', style: TextStyle(
                  fontFamily: 'Anonymous Pro', fontSize: 11, fontWeight: FontWeight.bold,
      ...
      actions: [
        TextButton(
          ...
          child: Text('cancel', style: TextStyle(fontFamily: 'Anonymous Pro', color: Colors.grey.shade500)),
        ),
        TextButton(
          ...
          child: Text('set', style: TextStyle(
            fontFamily: 'Anonymous Pro',
            fontWeight: FontWeight.bold,
            color: _selected != null ? widget.accent : Colors.grey.shade300,
          )),
        ),
      ],
    );
